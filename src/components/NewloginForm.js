...
const Newloginform = () => {
  ...
  return (
    <div
      className="card col-12 col-lg-2 login-card mt-2 hv-center"
      style={{ left: "550px", padding: "1px" }}
    >
      <form onSubmit={handleSubmit} style={{ backgroundColor: "#1fc2ba" }}>
        ...
        <div className="form-group text-left">
          ...
          <input
            ...
            onChange={handleChanges}
          />
          <button type="submit" disabled={isDisabled} className="bnt">
            Submit
          </button>
        </div>
      </form>
